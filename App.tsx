  ...
  return (
    ...
    >
      ...
      <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-transform group-hover:scale-110 ${
        active ? 'bg-tlp-pink text-white shadow-lg shadow-pink-900/40' : 'bg-slate-800 text-slate-400'
      }`}>
              ...
              <section>
                ...
                <div className="space-y-3">
                  {selectedDateBookings.length > 0 ? selectedDateBookings.map(b => (
                    ...
                    <p className="text-center py-6 text-slate-300 text-[10px] font-black uppercase tracking-widest italic italic border border-slate-100 border-dashed rounded-2xl">No athletes scheduled</p>
                  )}
                </div>
              </section>
            </div>
